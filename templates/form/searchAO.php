<form action="{{path('search_availability')}}" method="post">
    <div class="col-md-5">
        <div class="text-white bg-primary mb-3 justify-content-center">
            <div class="card-header">Recherche un(e) Aide Opératoire</div>
            <div class="card-body col-6">
                ...
                <select type="integer" name="zipCode" id="zipCode" class="form-select">
                    ...
                    <option value="" selected>S&eacute;lectionnez votre d&eacute;partement</option>
            ...
            <div class="formSubmit">
                <button type="submit" class="btn btn-light bt-lg mb-3">rechercher une Aide operatoire disponible</button>
            </div>
        </div>
    </div>
</form>
